...
#include "WaveletProceduralVolumeISPC.h"
#include <cmath>
#include "WaveletProceduralVolumeISPC_ispc.h"

namespace volley {
  namespace scalar_driver {

    void WaveletProceduralVolumeISPC::commit()
    {
      ...
      if (!ispcEquivalent) {
        ispcEquivalent = ispc::WaveletProceduralVolumeISPC_create(this);
      }

      ispc::WaveletProceduralVolumeISPC_set(ispcEquivalent,
                                            volumeData.data(),
    ...
    float WaveletProceduralVolumeISPC::getVoxel(
    ...
    float WaveletProceduralVolumeISPC::getWaveletValue(
    ...
    VLY_REGISTER_VOLUME(WaveletProceduralVolumeISPC,
