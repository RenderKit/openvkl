...
#endif
{
  VLY_NO_ERROR         = 0,  // No error has been recorded
  VLY_UNKNOWN_ERROR    = 1,  // An unknown error has occured
  VLY_INVALID_ARGUMENT = 2,  // An invalid argument is specified
  VLY_INVALID_OPERATION =
